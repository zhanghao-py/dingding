  ...
  <body>
    ...
    <nav class="bar bar-tab">
      <a class="tab-item" href="javascript:void(0)" onclick="showmenu()">
        ...
        <div class="menudiv" id="smfollowmenu" style="bottom:128px;">按菜单</div>
    	<div class="menudiv" id="smfollowmeat" style="bottom:88px;">按荤素</div>
    	<div class="menudiv" id="smfollowmaterial" style="bottom:48px">按食材</div>
      </a>
      ...
      <a class="tab-item" href="javascript:void(0)" onclick="showhis()">
        ...
        <div class="historydiv" id="smhistory" style="bottom:88px;">历史点餐</div>
    	<div class="historydiv" id="smallorder" style="bottom:48px;">全部订单</div>
      </a>
      <a class="tab-item" href="javascript:void(0)" onclick="showdisc()">
        <span class="icon discovery"></span>
        <span class="tab-label">餐厅发现</span>
        <div class="discoverydiv" id="smrestdisc" style="bottom:88px;">餐厅发现</div>
    	<div class="discoverydiv" id="smgroup" style="bottom:48px;">叮叮团</div>
      </a>
    </nav>
  </body>
